...
export default function InstructorCalendarView() {
  ...
  // 3. Next month padding days (35 or 42 total cells)
  ...
  return (
    <div style={{
      ...
      <div className="page-header" style={{ marginBottom: 12, flexShrink: 0 }}>
        <div>
          <h1 className="page-title" style={{ fontSize: 24 }}>My Calendar</h1>
          <p className="page-subtitle" style={{ fontSize: 13 }}>Visual monthly schedule of your assigned lectures</p>
        </div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 4, flex: 1, overflow: "hidden" }}>
                    {cell.lectures.map(lec => (
                      ...
                      >
                        ...
                        {/* Time & Batch */}
                        <div style={{
                          fontSize: 10, color: "var(--orange-600)", fontWeight: 700,
                          display: "flex", alignItems: "center", justifyContent: "space-between",
